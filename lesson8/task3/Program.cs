...
// void Massiv54321(int[,] array)
// {
//     int[,] NewArray = new int[array.GetLength(0) , array.GetLength(1)];
//     for (int i = 0; i < array.GetLength(0); i++)
//     {

//         int maxInd = NewArray[0,0];
...
//             if (NewArray[i, j] > maxInd)
//             {
//                 maxInd = NewArray[i, j];
//             }
//         }
//         int temp = NewArray[array.GetLength(0) - 1,array.GetLength(1)];
//         NewArray[array.GetLength(0) - 1,array.GetLength(1)] = maxInd;
//         maxInd = temp;
//     }
...
try
{
    ...
    //     // int m = 2;
    //     // int n = 3;
    Console.WriteLine("Вот сгенерированный двумерный 1 массив:");
    int[,] initialDoubleArray = FillDoubleArray(m, n);
    PrintDoubleArray(initialDoubleArray);
    Console.Write("Введите количество столбцов во второй матрице: \t");
    int r = Convert.ToInt32(Console.ReadLine());
    Console.WriteLine("Вот сгенерированный двумерный 2 массив:");
    int[,] initialDouble2Array = FillDoubleArray(n, r);
    PrintDoubleArray(initialDouble2Array);

    
    Console.WriteLine();
    Console.WriteLine("Результат перемножения матриц:");
    new_matrix(initialDoubleArray,initialDouble2Array);
